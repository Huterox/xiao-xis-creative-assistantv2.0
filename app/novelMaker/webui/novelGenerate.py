...
from app.novelMaker.handler.storyboardHandler import StoryBoardHandler
from app.novelMaker.handler.videoBuilder import VideoBuilder
...
class NovelGenerate:
    def __init__(self):
        ...
        self.default_img = self.current_dir+r"/../../novelMaker/assert/img/wait.jpg"
        self.default_audio = self.current_dir + r"/../../novelMaker/assert/audio/test01.mp3"
        self.sources = self.current_dir+"/../../novelMaker/resource/sources"
